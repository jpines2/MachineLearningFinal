...
def main(): 
    ...
    m10330_dump = open("m10330_supervised_dump.txt","w")
    for i in xrange(0, len(LHIPPO_content)):
        ...
        output_line = '1 ' + '1:'+LHIPPO_corr + ' 2:'+RHIPPO_corr + ' 3:'+LNEO_corr + ' 4:'+RNEO_corr + ' 5:' + BRAINSTEM_corr + ' 8:' + LTHAL_corr + ' 9:'+ RTHAL_corr + ' 10:' + LSTRIATUM_corr + ' 11:' + RSTRIATUM_corr + ' 12:' + LHYPO_corr + ' 13:' + RHYPO_corr
        m10330_dump.write(output_line+'\n')
    m10330_dump.close()
