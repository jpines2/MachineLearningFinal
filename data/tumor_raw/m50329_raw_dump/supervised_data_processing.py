...
def main(): 
    ...
    m50329_dump = open("m50329_supervised_dump.txt","w")
    for i in xrange(0, len(LHIPPO_content)):
        ...
        output_line = '1 ' + '1:'+LHIPPO_corr + ' 2:'+RHIPPO_corr + ' 3:'+LNEO_corr + ' 4:'+RNEO_corr + ' 5:' + BRAINSTEM_corr + ' 6:' + LOLF_corr + ' 7:' + ROLF_corr + ' 10:' + LSTRIATUM_corr + ' 11:' + RSTRIATUM_corr + ' 12:' + LHYPO_corr + ' 13:' + RHYPO_corr
        m50329_dump.write(output_line+'\n')
    m50329_dump.close()
